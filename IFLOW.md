...
|---------|----------|----------|----------|----------|
| 一等奖 | 两个金苹果 | 8件 | 0.835% | 252°-324° |
| 二等奖 | AK47-荣耀英雄 | 20件 | 2.505% | 324°-360°, 0°-36° |
| 三等奖 | 艾登（永久） | 19件 | 2.505% | 36°-108° |
| 四等奖 | 680个钻石 | 7件 | 0.835% | 108°-180° |
| 五等奖 | 谢谢惠顾 | 无限制 | 93.32% | 180°-252° |
...
if (random < 6.68 && hasAnyInventory) {
    // 中奖逻辑（6.68%概率）
    // 各奖项概率分配：金苹果0.835%，AK47 2.505%，艾登2.505%，钻石0.835%
} else {
    // 未中奖逻辑（93.32%概率）
}
```
